...
export default function middle() {
    ...
    const handledown = ()=>{
        ...
        document.getElementById("middle1").style.height = "50vh"
        ...
        <div className="middleBar">
            ...
            <div id="middle1" className="ItemCards">
               ...
               <div className="col-md-3 ele-col">
                    ...
                    <a target="_blank" href=" https://drive.google.com/file/d/1aqNPYm6SwdJwAOxXKGBok6ufLJrLVIqk/view?usp=sharing"><div className="ele-name btn">Web Dev Internship </div></a>
